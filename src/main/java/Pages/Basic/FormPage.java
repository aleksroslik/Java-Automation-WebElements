...
public class FormPage {
    ...
    public FormPage selectCommands(String value, String value2, WebDriver driver) {
        Actions action = new Actions(driver);
        action.keyDown(commandsSelection, Keys.CONTROL).perform();
        new Select(commandsSelection).selectByVisibleText(value);
        new Select(commandsSelection).selectByVisibleText(value2);
        return this;
    }
